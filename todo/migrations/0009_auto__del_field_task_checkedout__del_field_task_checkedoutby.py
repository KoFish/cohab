...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.checkedout'
        db.delete_column('todo_task', 'checkedout')

        # Deleting field 'Task.checkedoutby'
        db.delete_column('todo_task', 'checkedoutby_id')


    def backwards(self, orm):
        # Adding field 'Task.checkedout'
        db.add_column('todo_task', 'checkedout',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Task.checkedoutby'
        db.add_column('todo_task', 'checkedoutby',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='checkouts', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'todo.task': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
            'object': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tasks'", 'null': 'True', 'to': "orm['auth.User']"}),
