...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.repeater'
        db.alter_column('todo_task', 'repeater_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['todo.RepeatingTask']))

        # Changing field 'RepeatingTask.object'
        db.alter_column('todo_repeatingtask', 'object', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'RepeatingTask.delay'
        db.alter_column('todo_repeatingtask', 'delay', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'RepeatingTask.deadline'
        db.alter_column('todo_repeatingtask', 'deadline', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Task.repeater'
        db.alter_column('todo_task', 'repeater_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['todo.RepeatingTask']))

        # Changing field 'RepeatingTask.object'
        db.alter_column('todo_repeatingtask', 'object', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # User chose to not deal with backwards NULL issues for 'RepeatingTask.delay'
        raise RuntimeError("Cannot reverse this migration. 'RepeatingTask.delay' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'RepeatingTask.deadline'
        raise RuntimeError("Cannot reverse this migration. 'RepeatingTask.deadline' and its values cannot be restored.")
