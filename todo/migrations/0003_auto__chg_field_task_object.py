...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.object'
        db.alter_column('todo_task', 'object', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Task.object'
        db.alter_column('todo_task', 'object', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
