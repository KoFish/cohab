...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskAction.has_object'
        db.add_column('todo_taskaction', 'has_object',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskAction.has_object'
        db.delete_column('todo_taskaction', 'has_object')
    ...
    models = {
        ...
        'todo.taskaction': {
            ...
            'has_object': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
