...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskArea.slug'
        db.alter_column('todo_taskarea', 'slug', self.gf('django.db.models.fields.SlugField')(default=None, unique=True, max_length=255))
        # Adding unique constraint on 'TaskArea', fields ['slug']
        db.create_unique('todo_taskarea', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskArea', fields ['slug']
        db.delete_unique('todo_taskarea', ['slug'])


        # Changing field 'TaskArea.slug'
        db.alter_column('todo_taskarea', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))
